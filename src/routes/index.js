...
const { listTasks, registerTask, updateTask, deleteTask, deleteAllTasks, listOverdueTasks, listOverdueDetails } = require('../controllers/tasks');
...
routes.get('/tasks/overdue/details', listOverdueDetails);
